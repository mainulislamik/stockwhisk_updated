    ...
    if (visible) {
      ...
      if (product && product.id) {
        setForm({
          ...
          category: typeof product.category === "object" && product.category ? product.category.id : (product.category || null),
          brand: typeof product.brand === "object" && product.brand ? product.brand.id : (product.brand || null),
