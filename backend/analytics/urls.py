...
from .views import (
    ...
    ProductPerformanceOverviewView,
    ProfitOverviewView,
...
urlpatterns = [
    ...
    path("product-performance-overview/", ProductPerformanceOverviewView.as_view(), name="product-performance-overview"),
    path("profitability-analytics/", ProfitabilityAnalyticsView.as_view(), name="profitability-analytics"),
