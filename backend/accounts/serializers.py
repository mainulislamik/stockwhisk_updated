...
class UserSerializer(serializers.ModelSerializer):
    ...
    shop_pos_receipt_enabled = serializers.BooleanField(source="shop.pos_receipt_enabled", read_only=True, default=True)
    shop_service_enabled = serializers.BooleanField(source="shop.service_enabled", read_only=True, default=True)
    ...
    class Meta:
        ...
        fields = [
            ...
            "shop_emi_enabled", "shop_delivery_enabled", "shop_whatsapp_enabled", "shop_is_demo", "shop_business_type", "shop_barcode_prefix", "shop_offline_sale_mode", "shop_pos_print_mode", "shop_pos_receipt_enabled", "shop_service_enabled", "shop_reports_enabled", "shop_finance_enabled", "shop_manufacturing_enabled", "branch", "is_staff",
            "is_reseller",
        ]
        read_only_fields = ["id", "email", "role", "shop", "shop_name", "shop_code", "shop_phone", "shop_logo", "shop_emi_enabled", "shop_delivery_enabled", "shop_whatsapp_enabled", "shop_is_demo", "shop_business_type", "shop_barcode_prefix", "shop_offline_sale_mode", "shop_pos_print_mode", "shop_pos_receipt_enabled", "shop_service_enabled", "shop_reports_enabled", "shop_finance_enabled", "shop_manufacturing_enabled", "branch", "is_staff", "is_reseller"]
...
class ShopSettingsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "pos_print_mode", "pos_receipt_enabled", "service_enabled", "reports_enabled", "finance_enabled", "manufacturing_enabled"
        ]
