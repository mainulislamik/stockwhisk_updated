...
urlpatterns = [
    ...
    path("backups/drive-config/", PlatformConfigView.as_view(), name="backup-drive-config"),
    path("backups/drive-trigger/", TriggerDriveBackupView.as_view(), name="backup-drive-trigger"),
